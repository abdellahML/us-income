...
from utils.validation import crosstabing,cls_report,roc_curve_test, mat_cor,conf_matrix,heatmap_conf
...
def console_output(baseline_estimator, accuracy_grid, roc_grid):
    ...
    roc_curve_test(y_test=y_true_acc,y_pred_1=accuracy_proba[:,1],y_pred_2=roc_proba[:,1])
    return 
